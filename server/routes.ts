...
${dbContext}`,
  ...
  // Mobile: List measurements
  app.get(
    "/api/mobile/measurements",
    mobileAuthMiddleware,
    async (req: MobileAuthRequest, res: Response) => {
      try {
  ...
  // Mobile: Get measurement detail
  app.get(
    "/api/mobile/measurements/:id",
    mobileAuthMiddleware,
    async (req: MobileAuthRequest, res: Response) => {
      try {
        const measurement = await storage.getMeasurement(req.params.id);
  ...
  // Mobile: Create/update measurement (with sashes)
  app.post(
    "/api/mobile/measurements",
    mobileAuthMiddleware,
    async (req: MobileAuthRequest, res: Response) => {
  ...
  // Mobile: Delete measurement (only draft)
  app.delete(
    "/api/mobile/measurements/:id",
    mobileAuthMiddleware,
    async (req: MobileAuthRequest, res: Response) => {
  ...
  // Mobile: Send measurement to CRM → creates order
  app.post(
    "/api/mobile/measurements/:id/send",
    mobileAuthMiddleware,
    async (req: MobileAuthRequest, res: Response) => {
      try {
        const measurement = await storage.getMeasurement(req.params.id);
  ...
  // Mobile: Calculate coefficient (reuse server logic)
  app.post(
    "/api/mobile/coefficients/calculate",
    async (req: Request, res: Response) => {
      try {
        const { systemKey, category, width, height } = req.body;
        if (!systemKey || !category || !width || !height) {
